...
public class StringOperationsTest
{
	...
	@DisplayName("Palindrome string operation")
	@ParameterizedTest(name = "{0} -> {1}")
	@CsvSource({
			"asdf, false",
			"1234321, true",
	...
	public void IsPalindromeStringTest(String input, boolean output)
	{
		Assertions.assertEquals(output, operation.isPalindrome(input));
	}

	@Test
	public void IsPalindromeEmptyStringTest()
	{
		Assertions.assertTrue(operation.isPalindrome(""));
	}

	@Test
	public void IsPalindromeNullStringTest()
	{
		Assertions.assertThrows(NullPointerException.class, () -> operation.isPalindrome(null));
	}
}
